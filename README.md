...
<p>For a better experience while using our Service, we may use certain
    personally identifiable information, including but not limited to pictures, incoming call numbers, incoming text numbers, contact information. 
	The information that we use is retained on your device and is not
